(function() {
  ...
  // Typed Js
  $(".element").typed({
    strings: ["Jsem Instruktor Lyžování", "Jsem Instruktor Snowboardingu", "Jsem Fotograf", "Jsem Cestovatel"],
    typeSpeed: 1,
    backSpeed: 1,
    backDelay: 1000,
    loop: true
  ...
  $(".sub-title").typed({
    strings: ["Instruktor Lyžování", "Instruktor Snowboardingu", "Fotograf", "Cestovatel"],
    typeSpeed: 1,
    backSpeed: 1,
    backDelay: 1400,
    loop: true
